...
class GeneralDescriptionModel(Base):
    ...
    assessment = relationship(
        "BuildingAssessmentModel", back_populates="general_description"
    )
...
class PropertyAppraisalModel(Base):
    ...
    # Relationships
    assessment = relationship(
        "BuildingAssessmentModel", back_populates="property_appraisal"
    )
...
class AdditionalItemModel(Base):
    ...
    # Relationships
    assessment = relationship(
        "BuildingAssessmentModel", back_populates="additional_items"
    )
...
class AdditionalItemsSummaryModel(Base):
    ...
    # Relationships
    assessment = relationship(
        "BuildingAssessmentModel", back_populates="additional_items_summary"
    )
...
class SupersededRecordModel(Base):
    ...
    # Relationships
    building_assessment = relationship(
        "BuildingAssessmentModel", back_populates="superseded_records"
    )
...
class StructuralMaterialModel(Base):
    ...
    # Relationships
    assessment = relationship(
        "BuildingAssessmentModel", back_populates="structural_material"
    )
...
class BuildingAssessmentModel(Base):
    ...
    location = relationship(
        "BuildingLocationModel", back_populates="assessment", uselist=False
    )
    general_description = relationship(
        "GeneralDescriptionModel", back_populates="assessment", uselist=False
    )
    property_appraisal = relationship(
        "PropertyAppraisalModel", back_populates="assessment", uselist=False
    )
    additional_items = relationship("AdditionalItemModel", back_populates="assessment")
    additional_items_summary = relationship(
        "AdditionalItemsSummaryModel", back_populates="assessment", uselist=False
    )
    assessment_items = relationship(
        "PropertyAssessmentItemModel", back_populates="assessment"
    )
    memoranda = relationship("MemorandumModel", back_populates="assessment")
    superseded_records = relationship(
        "SupersededRecordModel", back_populates="building_assessment"
    )
    structural_material = relationship(
        "StructuralMaterialModel", back_populates="assessment", uselist=False
    )
